...
function loadPage() {
  ...
  if (!user) {
    ...
    console.log("Batch type:", typeof batch);
    ...
    if (batch === "ML") {
      ...
      console.log("✅ CLOUDARCHITECTAPRIL matched! Loading schedule...");
      ...
      // Default fallback
      console.log("⚠️ No batch match found! Loading default schedule. Batch was:", batch);
...
const scheduleCloudArchitectApril = [
...

  {
    ...
    details: "Agenda: delivered in English",
    link: "https://meet.google.com/ahj-kyce-zug",
  },
  {
    ...
    details: "Agenda: delivered in English",
    link: "https://meet.google.com/jxi-xyqk-cyj",
  },
  {
...
const scheduleAll = [
  ...
  },
  {
    ...
    details: "Agenda: delivered in English",
    link: "https://meet.google.com/ghc-khkm-poz"
  },
  {
  ...
  },
  {
    ...
    link: "https://meet.google.com/fuo-rzwp-dsv",
    recording: ""
  },
  {
    day: "Thu, December 11, 2025",
...
const scheduleACE24 = [
  ...
  },
  {
    ...
    description: "Academy - Associate Cloud Engineer workshop Module 2",
    details: "Agenda: delivered in English over 2 weeks",
    link: "https://meet.google.com/mmq-drza-iiz",
    recording: "https://youtube.com/live/v-r3yNkB_X8?feature=share",
  },
  {
    day: "Fri, December 5, 2025",
    ...
    description: "Academy - Associate Cloud Engineer workshop Module 3",
    details: "Agenda: delivered in English over 2 weeks",
    link: "https://meet.google.com/xsu-mfsg-hhz",
    recording: "",
  },
  {
    day: "Mon, December 8, 2025",
...
const schedulePDE01 = [
  {
    ...
    description: "Academy - Professional Data Engineer workshop Module 1",
    details: "Agenda: delivered in English",
    link: "https://meet.google.com/zgf-djxy-wiy",
    recording: ""
  },
  {
    day: "Fri, December 5, 2025",
    ...
    description: "Academy - Professional Data Engineer workshop Module 2",
    details: "Agenda: delivered in English",
    link: "https://meet.google.com/www-wfcg-ius"
  },
  {
    day: "Mon, December 8, 2025",
    time: "8:30 PM - 11:30 PM GMT+5:30",
...
function createSessionElement(session, isNext = false) {
  try {
    ...
    let end = null;
    if (endStrRaw) {
      const endStr = endStrRaw.trim().replace(/\s+GMT.*$/, "") + " GMT+0530";
...
function loadPage() {
  try {
    ...
    console.log("=== BATCH DEBUG INFO (Section 2) ===");
    console.log("User email:", user.email);
    ...
    if (batches.includes("ML")) loadSchedule(scheduleML);
    ...
    else if (batches.includes("CLOUDARCHITECTAPRIL")) {
      console.log("✅ CLOUDARCHITECTAPRIL matched in section 2!");
      loadSchedule(scheduleCloudArchitectApril);
    }
      ...
      console.log("⚠️ No matching batch found in section 2, loading default schedule. Batches:", batches);
      loadSchedule(schedule);
    }
  } catch (e) {
...
function checkAndSendAutoReminders() {
  try {
    ...
    batches.forEach(batch => {
      ...
      // Map to appropriate schedule (you can extend this based on your batches)
      if (batchUpper.includes('DECEMBER')) {
        currentSessions = [...currentSessions, ...scheduleAll];
      } else if (batchUpper.includes('NOVEMBER')) {
        currentSessions = [...currentSessions, ...scheduleAll];
      } else {
        currentSessions = [...currentSessions, ...scheduleAll];
      }
