...
(function () {
    ...
    if (!isDesktop) {
        console.log("SafeBrowser: Advanced security enhancements are disabled in web browser mode.");
        return; // Exit if not in desktop app to prevent breaking normal browser usage
    }

    console.log("SafeBrowser: Desktop environment detected. Activating full lockdown security.");
